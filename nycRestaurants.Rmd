...
Cleaning data for analysis of boros.
...
Exploring distribution of restaurants across boros.

```{r}
ggplot(nyc, aes(x=boro)) + geom_bar()
```

Cleaning data for analysis of grade distribution across boros.
...
Visualizing distribution of grades across boros.
